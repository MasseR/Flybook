...
public class Migrations {
    ...
    public Migrations(JDBCConnectionPool pool) {
        ...
        this.migrations.add("CREATE TABLE if not exists Users(username TEXT PRIMARY KEY, password TEXT, firstname TEXT, lastname TEXT, admin default false, email TEXT, optlock INTEGER DEFAULT 0)");

...
public class Migrations
{
    ...
    public Migrations(JDBCConnectionPool pool)
    {
        ...
        this.migrations.add("CREATE TABLE if not exists Users(username TEXT PRIMARY KEY, passwd TEXT , firstname TEXT , lastname TEXT , role TINYINT , email TEXT , optlock INTEGER DEFAULT 0)");
